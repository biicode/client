...
INCLUDE(${CMAKE_CURRENT_LIST_DIR}/../arduino_settings.cmake)
#=============================================================================#
#                           User Functions                                    
#=============================================================================#
...
function(GENERATE_ARDUINO_LIBRARY INPUT_NAME)
    ...
    target_link_libraries(${INPUT_NAME} PUBLIC ${ALL_LIBS} "-lc -lm")
endfunction()
...
function(setup_arduino_library VAR_NAME BOARD_ID LIB_PATH COMPILE_FLAGS LINK_FLAGS)
    ...
    if(NOT TARGET ${TARGET_LIB_NAME})
        ...
        if(LIB_SRCS)
            ...
            target_link_libraries(${TARGET_LIB_NAME} PUBLIC ${BOARD_ID}_CORE ${LIB_TARGETS})
...
function(setup_arduino_target TARGET_NAME BOARD_ID ALL_SRCS ALL_LIBS COMPILE_FLAGS LINK_FLAGS MANUAL)
    ...
    set_target_properties(${TARGET_NAME} PROPERTIES
                ...
                LINK_FLAGS "${ARDUINO_LINK_FLAGS} ${LINK_FLAGS}")
    target_link_libraries(${TARGET_NAME} PUBLIC ${ALL_LIBS} "-lc -lm")

    set(PATH_TO_SAVE ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
